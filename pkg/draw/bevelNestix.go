...
func Bevel(b *gen.BevelData) (name, nestix string) {
	...
	switch b.BevelCode {
	// NONE
	case -728, 728, 617, 727, 253, 103113, 103110, 103106, 103210, 203112, 0, 180, -253, -153, 113, -113, 153, -154, 181, 277, 717, 616, 177, -177, 143, -143, -243, 243, -203, 716, -716, -103, 203, -227, 227, 254, -254, -277, 255, -255, 103, 183:
		name = ""
		nestix = ""
	...
	case 245, 273, 216, 248, 215, 293, 310, 392, 346, 244, 261, 154:
		name = "TSV50"
		nestix = fmt.Sprintf("[V/45.0][S%.1f]", b.PlateThickness)
